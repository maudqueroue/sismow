...
#' 
#' transects <- create_transect(shape_obj = shape_courseulles,
#'                              design = "systematic",
#'                              line.length = 400000,
#'                              design.angle = 2)
#' # Plot
...
#'       theme(legend.position = "none")
#' 
create_transect <- function(shape_obj, design = "systematic", design.angle = 0, line.length, segmentize = FALSE, length_segs, crs = 2154, ...) {
